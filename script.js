...
h1.innerHTML = '<u>Variety of Dogs</u>'
h1.classList.add('text-center')
document.getElementById('cont').appendChild(h1)

let h3 = document.createElement('h3')
h3.innerHTML = 'Press the below Button to see various dog Image'
...
p.innerHTML = 'Various Dog Placeholder'
...
dogBut.innerHTML = "Press here to See"
